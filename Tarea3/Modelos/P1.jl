...
module ModeloP1
    ...
    function crear_modelo(e_anterior, afluente, M=nothing, N=nothing, e_optimo_previo=nothing)
        ...
        costo_etapa_actual = 50 * value.(pg_1) + 100 * value.(pg_2) + 150 * value.(pg_3)
        costo_futuro = value.(θ)

        return value.(e), precio_sombra, costo, costo_etapa_actual, costo_futuro,
                [value.(pg_1), value.(pg_2), value.(pg_3), value.(q)]
    end
    ...
    function modelo_P1()
        ...
        e_2_1_backward1 = resultado_backward1_etapa2_escenario1[1]
        e_2_2_backward1 = resultado_backward1_etapa2_escenario2[1]
        ...
        # Etapa 2
        resultado_forward2_etapa2_escenario1 = crear_modelo(resultado_forward2_etapa1_escenario1[1], afluentes[2][1], M_etapa3_escenario_1_2, N_etapa3_escenario_1_2, e_2_1_backward1)
        resultado_forward2_etapa2_escenario2 = crear_modelo(resultado_forward2_etapa1_escenario1[1], afluentes[2][2], M_etapa3_escenario_3_4, N_etapa3_escenario_3_4, e_2_2_backward1)
