...
module Montecarlo
    ...
    using Random, Statistics, Plots, .Structures

    export obtener_datos_MC
    ...
    function montecarlo_RE_excel(lista_gen::Vector{Gen},lista_RE::Vector{REnergy}) #Genera dos Excel para ver los datos a ojo
        ...
        #Crear XLSX
        XLSX.openxlsx("Datos/Montecarlo.xlsx", mode="w") do xf
            sh = xf[1]
            XLSX.rename!(sh, "Escenarios")
        ...
        XLSX.openxlsx("Datos/Intervalo.xlsx", mode="w") do xf
